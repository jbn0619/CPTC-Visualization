...
public class InjectNotifManager : MonoBehaviour
{
    #region Fields
    ...
    {
        Inject testInject = new Inject("Test Name", "TestDescription", System.DateTime.Now.ToShortTimeString(), 0f, System.DateTime.Now.ToShortDateString());
