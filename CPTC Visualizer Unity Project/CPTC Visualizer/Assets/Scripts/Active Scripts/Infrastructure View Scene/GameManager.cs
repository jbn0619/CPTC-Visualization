...
public class GameManager: Singleton<GameManager>
{
    ...
    [SerializeField]
    public float generateDummyAlertsTime;
    [SerializeField]
    private float generateDummyAlertsCount;
    /// <summary>
    /// Turning this on will automatically transfer to the Controller Scene when the Dummy Alerts Timer cycles.
    /// This is executing the same fnction as pressing the ToControllerScene button at every interval.
    /// </summary>
    [SerializeField]
    private bool autoGenerateDummyAlerts;
    ...
    void Update()
    {
        if (autoGenerateDummyAlerts)
        {
            generateDummyAlertsCount += Time.deltaTime;
            if(generateDummyAlertsCount >= generateDummyAlertsTime)
            {
                GoToControllerScene();
            }
        }
