...
public class TeamManager : MonoBehaviour
{
    ...
    public void InstanceTeams(List<int> _ids, List<InfrastructureData> _infraObjects)
    {
        ...
        for(int i = 0; i < teams.Count; i++)
        {
            ...
            teamObjects[i].GetComponent<TeamData>().SetData(teams[i].ID, teams[i].TeamName, teams[i].TeamColor, teams[i].Infra);
    ...
    public void SelectTeamView(int teamIndex)
    {
        ...
        if (teamIndex == -1)
        {
            ...
            foreach(NodeData n in mainInfra.Nodes)
            {
        ...
        else if (teamIndex >= 0 && teamIndex < teams.Count)
        {
            ...
            foreach (NodeData n in teamInfra.Nodes)
            {
                n.gameObject.SetActive(true);
            }
