...
namespace Assets.Scripts
{
    ...
    /// <summary>
    /// The top level JSON reciever. Calls other classes to properly gather the information from
    ///     the JSON file.
    /// </summary>
    [Serializable]
    public class JSONReciever
    {
        public List<RecieverTeam> teams;
        public RecieverInfrastructure infrastructure;
    }

    [Serializable]
    public class RecieverInfrastructure
    {
        public RecieverNetwork[] networks;
    }

    [Serializable]
    public class RecieverNetwork
    {
        public int networkId;
        public RecieverNode[] nodes;
    }

    [Serializable]
    public class RecieverNode
    {
        public int id;
        public string type;
    ...
    [Serializable]
    public class RecieverTeam
    {
        public int teamId;
        public RecieverAlert[] alerts;
        public int[] discoveredNodeIds;
    }

    [Serializable]
    public class RecieverAlert
    {
        public string type;
    }
}
